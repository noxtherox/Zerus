    ...
    pub fn link(self) {
        ...
        for package in self.packages {
            ...
            command
                ...
                // Select the package graph's platform as well as the compiler target.
                // Without this, SwiftPM 6.4 resolves the package for the host Mac and
                // appends a conflicting macOS SDK after the iOS compiler overrides.
            ...
            let search_path = out_path
                // SwiftPM exposes this stable symlink for the selected triple.
                .join(configuration);
